                        ...
                        <Form model='feedback' onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className='form-group'>
                                ...
                                <Control.text model='.telnum' className='form-control' id="telnum" name="telnum" 
                                        placeholder="Tel. Number" validators={{required,minLength: minLength(3), maxLength : maxLength(15), isNumber }} />
                                        <Errors className='text-danger'
                                        model=".telnum"
                                        show='touched'
                                        messages={{
                            ...
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    <Control.text model='.email' id='email' name='email' className='form-control' placeholder='Email' validators={{required,isEmail }} ></Control.text>
                                    <Errors className='text-danger'
                                        model=".email"
                                        show='touched'
                                        messages={{
